...
namespace siteReader.Params
{
...

    {
        ...
        //CLOUD METHODS----------------------------------------------------
        public void GetPointCloud(float density, List<Mesh> cropShapes = null, bool inside = false)
        {
            (_ptCloud, _intensity, _rgb, _classification, _numReturns) = LasMethods.GetPtCloud(this, density, cropShapes, inside);
        }
