...
namespace siteReader.Methods
{
    public static class Utility
    {
        ...
        public static List<g3.Vector3d> GetVertices(Mesh mesh)
        {
            var vertices = new List<g3.Vector3d>();

            foreach (var vert in mesh.Vertices)
            {
                var coords = new g3.Vector3d(vert.X, vert.Y, vert.Z);
                vertices.Add(coords);
            }
        ...
        public static List<g3.Vector3d> GetNormals(Mesh mesh)
        {
            var normals = new List<g3.Vector3d>();

            foreach (var norm in mesh.Normals)
            {
                var normal = new g3.Vector3d(norm.X, norm.Y, norm.Z);
                normals.Add(normal);
            }
